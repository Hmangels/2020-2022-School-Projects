...
if(isset($_GET)){
	if($_GET['page'] === "form"){
		...
		header("Location: http://206.189.197.113/CPS276/Assignments/Assignment10/index.php?page=form");
	}
}
else {
	
	header("Location: http://206.189.197.113/CPS276/Assignments/Assignment10/index.php?page=display");
}
?>
